...
**Ne jamais blâmer l'utilisateur.**
**Jamais d'humour pour les erreurs** — l'utilisateur est déjà frustré.
...
**La voix** est la personnalité de Brique Rouge — constante partout.
...
- **Alt text** : décrire l'information, pas l'image
- **Boutons icône** : `aria-label` obligatoire
- `alt=""` pour les images décoratives

---

**À éviter :** Jargon sans explication. Blâmer l'utilisateur. Erreurs vagues. Terminologie variable. Humour dans les états d'erreur. Lorem ipsum.
