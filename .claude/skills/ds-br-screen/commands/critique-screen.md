...
description: Évalue un écran du DS @brique-rouge d'un point de vue UX et design : hiérarchie visuelle, architecture d'information, résonance émotionnelle, charge cognitive. Génère un rapport scoré avec feedback actionnable.
user-invocable: true
...
- Correspond-il à la personnalité du DS @brique-rouge ?
